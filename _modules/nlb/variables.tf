...
#   description = "The port for the TCP listener"
# }
#variable "tcp_port_start" {
#  type        = number
#  default     = 8881
#  description = "The starting port for the TCP listener range"
#}
#
#variable "tcp_port_end" {
#  type        = number
#  default     = 8889
#  description = "The ending port for the TCP listener range"
#}
#
#locals {
#  tcp_port_range = range(var.tcp_port_start, var.tcp_port_end + 1)
#}
#
#variable "tcp_ports_dev" {
#  type        = list(number)
#  default     = local.tcp_port_range
...
variable "tcp_ports_alb" {
  type        = list(number)
  default     = []
  description = "The port for the TCP listeners"
}
...
variable "target_group_protocol_tcp" {
  type        = string
  default     = "TCP"
  description = "The protocol for the default target group TCP"
}

variable "target_group_protocol_https" {
  type        = string
  default     = "HTTPS"
  description = "The protocol for the default target group HTTPS"
}

variable "target_group_protocol_tls" {
  type        = string
  default     = "TLS"
  description = "The protocol for the default target group TLS"
}
