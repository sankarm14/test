module "efsserver" {
  ...
  user_data = <<-EOF
      ...
      echo "10.10.1.21:/ /home/bo1-logs/bo1/logs nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
      echo "Configuring fstab"
      sudo mount -a
      sudo mkdir -p /home/bo2-logs/bo2/logs
      echo "Configuring fstab"
      echo "10.10.1.77:/ /home/bo2-logs/bo2/logs nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
      echo "Mounting EFS file system"
      sudo mount -a
      sudo mkdir -p /home/script-logs/script/logs
      echo "Configuring fstab"
      echo "10.10.1.39:/ /home/script-logs/script/logs nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
      echo "Mounting EFS file system"
      sudo mount -a
      sudo mkdir -p /home/txn-logs/txn/logs
      echo "Configuring fstab"
      echo "10.10.1.29:/ /home/txn-logs/txn/logs nfs4 nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab
      echo "Mounting EFS file system"
      sudo mount -a
      EOF
}